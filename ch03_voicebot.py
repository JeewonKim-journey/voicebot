...
def main():
    ...
    #기본설명
    with st.expander("About Voice Assistant Prpgram", expanded = True):
        st.write(
        """
        - The UI of the voice assistant program utilized Streamlit.
        - STT(Speech-To-Text) utilizes OpenAI's Whisper AI.
        - Responses are generated using OpenAI's GPT model.
        - TTS(Text-To-Speech) utilizes Google's Google Translate TTS.
        """
        )
